...
extern EIF_TYPED_VALUE F390_4605(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F390_4606(EIF_REFERENCE);
extern EIF_TYPED_VALUE F390_4607(EIF_REFERENCE);
extern void F390_7652(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F390_4605 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 389, Current, 2, 1, 7034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(389, Current, 7034);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1985, "item", arg1))(arg1)).it_i4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F390_4606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 7035);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(389, Current, 7035);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F390_4607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 389, Current, 0, 0, 7036);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(389, Current, 7036);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F390_7652 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 389, Current, 0, 7651);
	RTSA(dtype);
	RTME(dtype, 0);
