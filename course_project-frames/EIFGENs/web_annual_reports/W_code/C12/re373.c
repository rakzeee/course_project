...
extern EIF_TYPED_VALUE F373_4321(EIF_REFERENCE);
extern EIF_TYPED_VALUE F373_4324(EIF_REFERENCE);
extern void F373_7647(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F373_4321 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 372, Current, 0, 0, 5411);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(372, Current, 5411);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F373_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 372, Current, 0, 0, 5412);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(372, Current, 5412);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F373_7647 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 372, Current, 0, 7646);
	RTSA(dtype);
	RTME(dtype, 0);
