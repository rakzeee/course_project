...
extern EIF_TYPED_VALUE F668_2233(EIF_REFERENCE);
extern void F668_7620(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F668_2233 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 667, Current, 0, 0, 2479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(667, Current, 2479);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F668_7620 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 667, Current, 0, 7619);
	RTSA(dtype);
	RTME(dtype, 0);
