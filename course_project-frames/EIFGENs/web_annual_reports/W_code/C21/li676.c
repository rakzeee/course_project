...
extern EIF_TYPED_VALUE F676_4605(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F676_4606(EIF_REFERENCE);
extern EIF_TYPED_VALUE F676_4607(EIF_REFERENCE);
extern void F676_7652(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F676_4605 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 675, Current, 2, 1, 7054);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 7054);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1985, "item", arg1))(arg1)).it_n4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F676_4606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 675, Current, 0, 0, 7055);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 7055);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F676_4607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 675, Current, 0, 0, 7056);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(675, Current, 7056);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F676_7652 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 675, Current, 0, 7651);
	RTSA(dtype);
	RTME(dtype, 0);
