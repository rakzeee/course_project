...
extern void F574_4204(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F574_4205(EIF_REFERENCE);
extern EIF_TYPED_VALUE F574_4206(EIF_REFERENCE);
extern EIF_TYPED_VALUE F574_4207(EIF_REFERENCE);
extern EIF_TYPED_VALUE F574_4208(EIF_REFERENCE);
extern EIF_TYPED_VALUE F574_4209(EIF_REFERENCE);
...
void F574_4204 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 573, Current, 0, 1, 5146);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(573, Current, 5146);
	RTCC(arg1, 573, l_feature_name, 1, RTWCT(3490, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3490, 0xF800023A, 0); /* target */
	RTAR(Current, arg1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 573, Current, 0, 0, 5148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(573, Current, 5148);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F574_4207 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 573, Current, 0, 0, 5149);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(573, Current, 5149);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F574_4208 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F574_4209 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
