...
extern void F575_4609(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F575_4611(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F575_4612(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F575_4616(EIF_REFERENCE);
...
void F575_4609 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 574, Current, 1, 1, 7098);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 7098);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uu1_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3771, dtype))(Current, uu1_1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uu1_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3773, dtype))(Current, uu1_1x);
			RTHOOK(8);
...
void F575_4611 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 574, Current, 0, 1, 7099);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 7099);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1985, "item", arg1))(arg1)).it_n1);
		uu1_1 = tu1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3772, dtype))(Current, uu1_1x);
		RTHOOK(8);
...
void F575_4612 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 574, Current, 0, 1, 7100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 7100);
	RTCC(arg1, 574, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F575_4616 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 574, Current, 0, 0, 7101);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 7101);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
