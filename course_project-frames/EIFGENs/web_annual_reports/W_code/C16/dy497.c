...
extern void F497_4616(EIF_REFERENCE);
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 496, Current, 1, 1, 7090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(496, Current, 7090);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uw1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3771, dtype))(Current, uw1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uw1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3773, dtype))(Current, uw1x);
			RTHOOK(8);
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 496, Current, 0, 1, 7091);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(496, Current, 7091);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tw1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1985, "item", arg1))(arg1)).it_c4);
		uw1 = tw1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3772, dtype))(Current, uw1x);
		RTHOOK(8);
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 496, Current, 0, 1, 7092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(496, Current, 7092);
	RTCC(arg1, 496, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F497_4616 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 496, Current, 0, 0, 7093);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(496, Current, 7093);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
