...
extern EIF_TYPED_VALUE F120_1805(EIF_REFERENCE);
...
RTOID (F120_1805)
EIF_TYPED_VALUE F120_1805 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 119, Current, 0, 0, 1750);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(119, Current, 1750);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
