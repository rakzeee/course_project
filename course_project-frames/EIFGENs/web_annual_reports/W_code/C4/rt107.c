...
extern void F107_1623(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F107_1624(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F107_1623 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 106, Current, 0, 1, 1577);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(106, Current, 1577);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F107_1624 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 106, Current, 0, 1, 1578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(106, Current, 1578);
	RTCC(arg1, 106, l_feature_name, 1, eif_new_type(275, 0x01), 0x01);
	RTIV(Current, RTAL);
