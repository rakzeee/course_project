...
extern EIF_TYPED_VALUE F126_1866(EIF_REFERENCE);
...
EIF_TYPED_VALUE F126_1865 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 125, Current, 0, 0, 1810);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1079, 72))(Current)).it_i4);
...
RTOID (F126_1866)
EIF_TYPED_VALUE F126_1866 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 125, Current, 0, 0, 1811);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
