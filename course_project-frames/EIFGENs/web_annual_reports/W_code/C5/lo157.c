...
EIF_TYPED_VALUE F157_1942 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 156, Current, 0, 0, 1887);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(156, Current, 1887);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1085, 72))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 156, Current, 0, 0, 1888);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(156, Current, 1888);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
