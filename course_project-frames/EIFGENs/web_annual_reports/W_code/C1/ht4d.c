...
static const EIF_TYPE_INDEX egt_1_4 [] = {0xFF01,354,3,0xFFFF};
...
static const EIF_TYPE_INDEX egt_11_4 [] = {0xFF01,22,0xFFFF};
...
static const struct desc_info desc_4[] = {
	...
	{EIF_NON_GENERIC(0x020D /*262*/), 89, 0},
};
void Init4(void)
{
	IDSC(desc_4, 0, 3);
	IDSC(desc_4 + 1, 2, 3);
	IDSC(desc_4 + 32, 348, 3);
}
