...
extern EIF_TYPED_VALUE F27_554(EIF_REFERENCE);
extern EIF_TYPED_VALUE F27_555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F27_556(EIF_REFERENCE);
extern EIF_TYPED_VALUE F27_557(EIF_REFERENCE);
extern EIF_TYPED_VALUE F27_558(EIF_REFERENCE);
extern EIF_TYPED_VALUE F27_559(EIF_REFERENCE);
extern EIF_TYPED_VALUE F27_560(EIF_REFERENCE);
extern EIF_TYPED_VALUE F27_561(EIF_REFERENCE);
...
EIF_TYPED_VALUE F27_554 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F27_554,631,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F27_555)
EIF_TYPED_VALUE F27_555 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 26, Current, 0, 0, 631);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(26, Current, 631);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F27_556)
EIF_TYPED_VALUE F27_556 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 26, Current, 0, 0, 632);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(26, Current, 632);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80001C5, 0,0); /* Result */
...
RTOID (F27_557)
EIF_TYPED_VALUE F27_557 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 26, Current, 0, 0, 633);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(26, Current, 633);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80001C5, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 26, Current, 0, 0, 626);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F27_559 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F27_559,628,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F27_560 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F27_560,629,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F27_561 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F27_561,630,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
