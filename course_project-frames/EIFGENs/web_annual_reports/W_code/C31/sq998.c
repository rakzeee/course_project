...
extern void F998_8193(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F998_8194(EIF_REFERENCE);
...
void F998_8193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 997, Current, 1, 2, 14104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14104);
	RTCC(arg1, 997, l_feature_name, 1, eif_new_type(989, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) (ti8_1 <= ti8_2)) {
		...
		ti8_1 = *(EIF_INTEGER_64 *)(Current + RTWA(6345, dtype));
		ui8_1 = ti8_1;
		loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5914, 964))(Current, up1x, ui4_1x, ui8_1x)).it_i4);
	}
	RTHOOK(9);
	ui4_1 = loc1;
...
EIF_TYPED_VALUE F998_8194 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT64;
	r.it_i8 = *(EIF_INTEGER_64 *)(Current + RTWA(6351,Dtype(Current)));
	return r;
}
