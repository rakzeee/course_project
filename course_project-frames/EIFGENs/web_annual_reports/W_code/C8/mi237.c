...
extern void F237_3921(EIF_REFERENCE);
extern EIF_TYPED_VALUE F237_3922(EIF_REFERENCE);
...
void F237_3921 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 236, Current, 2, 0, 4357);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(236, Current, 4357);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	ur1 = RTCCL(loc1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1642, "raise_retrieval_exception", loc2))(loc2, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
RTOID (F237_3922)
EIF_TYPED_VALUE F237_3922 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 236, Current, 0, 0, 4358);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(236, Current, 4358);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
