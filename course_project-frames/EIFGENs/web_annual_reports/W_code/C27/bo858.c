...
extern EIF_TYPED_VALUE F858_2233(EIF_REFERENCE);
extern void F858_7620(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F858_2233 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 857, Current, 0, 0, 2491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(857, Current, 2491);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F858_7620 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 857, Current, 0, 7619);
	RTSA(dtype);
	RTME(dtype, 0);
