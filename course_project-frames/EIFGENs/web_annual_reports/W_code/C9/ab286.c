...
extern EIF_TYPED_VALUE F286_5878(EIF_REFERENCE);
...
EIF_TYPED_VALUE F286_5878 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 285, Current, 0, 0, 10384);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(285, Current, 10384);
	RTIV(Current, RTAL);
	RTHOOK(1);
