...
extern EIF_TYPED_VALUE F343_7357(EIF_REFERENCE);
extern EIF_TYPED_VALUE F343_7358(EIF_REFERENCE);
extern EIF_TYPED_VALUE F343_7359(EIF_REFERENCE);
extern EIF_TYPED_VALUE F343_7361(EIF_REFERENCE);
extern void F343_7366(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F343_7357 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(5666,Dtype(Current)));
	return r;
}


/* {RT_DBG_VALUE_RECORD}.type */
EIF_TYPED_VALUE F343_7358 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F343_7359 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F343_7361 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 342, Current, 0, 0, 12656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(342, Current, 12656);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = tr2;
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4663, "plus", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
void F343_7366 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 342, Current, 0, 1, 12657);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(342, Current, 12657);
	RTCC(arg1, 342, l_feature_name, 1, RTWCT(5668, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5668, 0xF80000FE, 0); /* breakable_info */
	RTAR(Current, arg1);
