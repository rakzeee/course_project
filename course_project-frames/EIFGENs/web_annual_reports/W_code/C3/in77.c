...
extern EIF_TYPED_VALUE F77_1205(EIF_REFERENCE);
extern EIF_TYPED_VALUE F77_1206(EIF_REFERENCE);
extern EIF_TYPED_VALUE F77_1207(EIF_REFERENCE);
extern void F77_1208(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F77_1205 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 76, Current, 1, 0, 1210);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(76, Current, 1210);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F77_1206)
EIF_TYPED_VALUE F77_1206 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1211);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(76, Current, 1211);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F77_1207)
EIF_TYPED_VALUE F77_1207 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1212);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(76, Current, 1212);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800004D, 0,0); /* Result */
...
void F77_1208 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 76, Current, 0, 1, 1213);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(76, Current, 1213);
