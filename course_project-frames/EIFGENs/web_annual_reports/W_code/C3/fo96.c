...
extern void F96_1417(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {FORM_HANDLER}.execute */
void F96_1417 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 95, Current, 3, 3, 1386);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(95, Current, 1386);
	RTCC(arg1, 95, l_feature_name, 1, eif_new_type(275, 0x01), 0x01);
	RTCC(arg2, 95, l_feature_name, 2, eif_new_type(335, 0x01), 0x01);
	RTCC(arg3, 95, l_feature_name, 3, eif_new_type(66, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(3240, Dtype(tr1)))(tr1);
	RTNHOOK(5,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(6);
	RTDBGAL(Current, 2, 0xF80000E9, 0, 0); /* loc2 */
	tr1 = RTLN(eif_new_type(233, 0x01).id);
	tr2 = RTMS_EX_H("succes.html",11,753832812);
	ur1 = tr2;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5479, "form_parameters", arg2))(arg2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	for (;;) {
		...
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4259, "as_string_8", tr3))(tr3)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur1 = RTCCL(tr2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(472, "put_string", tr1))(tr1, ur1x);
		RTHOOK(9);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(27, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(9,1);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(492, "new_line", tr1))(tr1);
		RTHOOK(10);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2023, "forth", loc3))(loc3);
	}
	RTHOOK(11);
	tr1 = RTMS_EX_H("123",3,3224115);
	ur1 = tr1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3248, "put_string", loc1))(loc1, ur1x);
	RTHOOK(12);
	ur1 = RTCCL(loc1);
