...
extern EIF_TYPED_VALUE F402_4605(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F402_4606(EIF_REFERENCE);
extern EIF_TYPED_VALUE F402_4607(EIF_REFERENCE);
extern void F402_7652(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F402_4605 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 401, Current, 2, 1, 7038);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(401, Current, 7038);
...
body:;
	if (RTAL & CK_ENSURE) {
		...
		RTE_OE
		RTE_OT
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1947, "index", arg1))(arg1)).it_i4);
		ti4_2 = ti4_3;
		tr2 = NULL;
		RTE_O
		tr2 = RTLA;
	...
	if (RTCEQ(Current, arg1)) {
		...
		tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1930, "is_empty", arg1))(arg1)).it_b);
		...
		if (tb1) {
			RTHOOK(6);
			tb1 = '\0';
			tr3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2000, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			loc1 = RTCCL(tr3);
			if ((EIF_TRUE)) {
				tr3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2000, "cursor", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				loc2 = RTCCL(tr3);
				tb1 = (EIF_TRUE);
			}
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1985, "item", arg1))(arg1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
/* {LIST}.after */
EIF_TYPED_VALUE F402_4606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 401, Current, 0, 0, 7039);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(401, Current, 7039);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F402_4607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 401, Current, 0, 0, 7040);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(401, Current, 7040);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1947, Dtype(Current)))(Current)).it_i4);
...
/* {LIST}._invariant */
void F402_7652 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 401, Current, 0, 7651);
	RTSA(dtype);
	RTME(dtype, 0);
