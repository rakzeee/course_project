...
extern void F904_2310(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F904_2311(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F904_2310 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 903, Current, 0, 1, 2676);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(903, Current, 2676);
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F904_2311 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 903, Current, 1, 1, 2677);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(903, Current, 2677);
	{
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(6);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1938, "item", arg1))(arg1)).it_b);
		ub1 = tb2;
	...
	for (;;) {
		...
		if (!tb3) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1968, dtype))(Current)).it_b);
			tb2 = (EIF_BOOLEAN) !tb3;
		}
		if (tb2) break;
		RTHOOK(9);
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1985, "item", loc1))(loc1)).it_b);
		ub1 = tb3;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1972, dtype))(Current, ub1x);
		RTHOOK(10);
