...
extern EIF_TYPED_VALUE F900_4682(EIF_REFERENCE);
extern void F900_4683(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F900_4684(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F900_4685(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F900_4686(EIF_REFERENCE);
extern EIF_TYPED_VALUE F900_4687(EIF_REFERENCE);
extern EIF_TYPED_VALUE F900_4688(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F900_4682 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 899, Current, 1, 0, 7279);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 7279);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.force */
void F900_4683 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 899, Current, 0, 1, 7280);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 7280);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.extend */
void F900_4684 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 899, Current, 0, 1, 7281);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 7281);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {LINKED_STACK}.put */
void F900_4685 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 899, Current, 0, 1, 7282);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 7282);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {LINKED_STACK}.remove */
void F900_4686 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 899, Current, 0, 0, 7283);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 7283);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3799, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
EIF_TYPED_VALUE F900_4687 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 899, Current, 1, 0, 7284);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 7284);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1972, "extend", Result))(Result, ub1x);
		RTHOOK(6);
...
EIF_TYPED_VALUE F900_4688 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 899, Current, 3, 1, 7285);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(899, Current, 7285);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		for (;;) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3798, dtype))(Current)).it_b);
			ub1 = tb2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3773, "put_right", loc3))(loc3, ub1x);
			RTHOOK(12);
