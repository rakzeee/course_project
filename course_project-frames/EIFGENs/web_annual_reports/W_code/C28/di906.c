...
extern EIF_TYPED_VALUE F906_2301(EIF_REFERENCE);
extern EIF_TYPED_VALUE F906_2302(EIF_REFERENCE);
extern void F906_2303(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F906_7623(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F906_2301 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 905, Current, 0, 0, 2672);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(905, Current, 2672);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F906_2302 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 905, Current, 0, 0, 2673);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(905, Current, 2673);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1930, Dtype(Current)))(Current)).it_b);
...
/* {DISPENSER}.append */
void F906_2303 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 905, Current, 0, 1, 2674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(905, Current, 2674);
	{
...
void F906_7623 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 905, Current, 0, 7622);
	RTSA(dtype);
	RTME(dtype, 0);
