...
extern EIF_TYPED_VALUE F755_2235(EIF_REFERENCE);
extern EIF_TYPED_VALUE F755_2236(EIF_REFERENCE);
extern EIF_TYPED_VALUE F755_2237(EIF_REFERENCE);
extern EIF_TYPED_VALUE F755_2238(EIF_REFERENCE);
extern void F755_2239(EIF_REFERENCE);
extern void F755_7621(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F755_2235 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F755_2236 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F755_2237 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 754, Current, 0, 0, 2543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(754, Current, 2543);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F755_2238 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 754, Current, 0, 0, 2544);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(754, Current, 2544);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F755_2239 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 754, Current, 0, 0, 2545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(754, Current, 2545);
	RTIV(Current, RTAL);
...
void F755_7621 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 754, Current, 0, 7620);
	RTSA(dtype);
	RTME(dtype, 0);
