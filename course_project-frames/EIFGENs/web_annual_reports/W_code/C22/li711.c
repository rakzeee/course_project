...
extern EIF_TYPED_VALUE F711_4605(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F711_4606(EIF_REFERENCE);
extern EIF_TYPED_VALUE F711_4607(EIF_REFERENCE);
extern void F711_7652(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F711_4605 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 710, Current, 2, 1, 7058);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(710, Current, 7058);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu2_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1985, "item", arg1))(arg1)).it_n2);
...
EIF_TYPED_VALUE F711_4606 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 710, Current, 0, 0, 7059);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(710, Current, 7059);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F711_4607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 710, Current, 0, 0, 7060);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(710, Current, 7060);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F711_7652 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 710, Current, 0, 7651);
	RTSA(dtype);
	RTME(dtype, 0);
