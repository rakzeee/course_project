...
extern EIF_TYPED_VALUE F703_2233(EIF_REFERENCE);
extern void F703_7620(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F703_2233 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 702, Current, 0, 0, 2481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(702, Current, 2481);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F703_7620 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 702, Current, 0, 7619);
	RTSA(dtype);
	RTME(dtype, 0);
