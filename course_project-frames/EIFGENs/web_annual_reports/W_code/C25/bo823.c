...
extern EIF_TYPED_VALUE F823_2233(EIF_REFERENCE);
extern void F823_7620(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F823_2233 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 822, Current, 0, 0, 2489);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(822, Current, 2489);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F823_7620 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 822, Current, 0, 7619);
	RTSA(dtype);
	RTME(dtype, 0);
