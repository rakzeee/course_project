...
extern EIF_TYPED_VALUE F788_2233(EIF_REFERENCE);
extern void F788_7620(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F788_2233 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 787, Current, 0, 0, 2487);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 2487);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F788_7620 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 787, Current, 0, 7619);
	RTSA(dtype);
	RTME(dtype, 0);
