...
extern void F763_4609(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F763_4611(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F763_4612(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F763_4616(EIF_REFERENCE);
...
void F763_4609 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 762, Current, 1, 1, 7114);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(762, Current, 7114);
	RTIV(Current, RTAL);
...
void F763_4611 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 762, Current, 0, 1, 7115);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(762, Current, 7115);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3772, dtype))(Current, ub1x);
		RTHOOK(8);
...
void F763_4612 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 762, Current, 0, 1, 7116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(762, Current, 7116);
	RTCC(arg1, 762, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F763_4616 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 762, Current, 0, 0, 7117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(762, Current, 7117);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
